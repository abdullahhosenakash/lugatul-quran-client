...
const Admin = () => {
  ...
  const handleUpdate = (event) => {
    ...
    fetch("https://lugatul-quran-server.onrender.com/postWord", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="container mt-5 pt-4 home-page">
      <Form onSubmit={handleUpdate}>
        <Form.Group
          className="mb-3 text-end arabic-word-input"
        ...
        <Form.Group
          className="mb-3 text-end bangla-meaning-input"
        ...
        >
          <Form.Control
            ...
            name="banglaMeaning"
            className="text-end fs-1"
            placeholder="শব্দার্থ"
            required
          />
        </Form.Group>
        <button
          className="btn btn-dark d-inline-block mb-4 py-3 update-button"
